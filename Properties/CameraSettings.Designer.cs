...
namespace heliomaster_wpf.Properties {
    ...
    public sealed partial class CameraSettings : global::System.Configuration.ApplicationSettingsBase {
        ...
        [global::System.Configuration.DefaultSettingValueAttribute("<?xml version=\"1.0\" encoding=\"utf-16\"?>\r\n<ArrayOfCameraModel xmlns:xsi=\"http://ww" +
            ...
            "             <Index>0</Index>\r\n                            <Name>Visible</Name>\r" +
            "\n                            <LocalPathFormat>C:\\\\Users\\\\Kosio\\\\Desktop\\\\test_ou" +
            "t\\\\visible\\\\{DateTime:yyyyMMddTHHmmss}.png</LocalPathFormat>\r\n                  " +
            "          <RemotePathFormat>/home/sun_monitor/ftp_public/ftp_test/image_helios_{" +
            "Cam}_{DateTime:yyyyMMddTHHmmss}.bmp</RemotePathFormat>\r\n                        " +
            "    <RemoteCommandFormat>uptime 1&gt;&amp;2</RemoteCommandFormat>\r\n             " +
            "               <Flip>false</Flip>\r\n                            <Rotate>0\r\n</Rota" +
            "te>\r\n                        </CameraModel>\r\n                        <CameraMode" +
            "l>\r\n                            <Index>1</Index>\r\n                            <N" +
            "ame>Halpha</Name>\r\n                            <LocalPathFormat>C:\\\\Users\\\\Kosio" +
            "\\\\Desktop\\\\test_out\\\\halpha\\\\{DateTime:yyyyMMddTHHmmss}.png</LocalPathFormat>\r\n " +
            "                           <RemotePathFormat>/home/sun_monitor/ftp_public/ftp_te" +
            "st/image_helios_{Cam}_{DateTime:yyyyMMddTHHmmss}.bmp</RemotePathFormat>\r\n       " +
            "                     <RemoteCommandFormat>pwd</RemoteCommandFormat>\r\n           " +
            "                 <Flip>false</Flip>\r\n                            <Rotate>0</Rota" +
            "te>\r\n                        </CameraModel>                    </ArrayOfCameraMo" +
            "del>")]
