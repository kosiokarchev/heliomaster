...
namespace heliomaster {
    public class FlexPanel : Panel {
        ...
        public static readonly DependencyProperty FlexProperty = DependencyProperty.RegisterAttached("Flex", typeof(bool), typeof(FlexPanel), new PropertyMetadata(true));
        ...
        public bool Greedy {
            get => (bool) GetValue(GreedyProperty);
            set => SetValue(GreedyProperty, value);
        }
        public static readonly DependencyProperty GreedyProperty = DependencyProperty.Register(nameof(Greedy), typeof(bool), typeof(FlexPanel), new PropertyMetadata(false));
        ...
        protected override Size MeasureOverride(Size availableSize) {
            ...
            return !Greedy || double.IsPositiveInfinity(availableSize.Height) || double.IsPositiveInfinity(availableSize.Width)
        ...
        protected override Size ArrangeOverride(Size finalSize) {
            ...
            if (Orientation == Orientation.Vertical) {
                ...
                foreach (UIElement child in Children) {
                    ...
                    if (GetFlex(child)) arrangeRect = new Rect(0, currentLength, finalSize.Width, child.DesiredSize.Height + flexSize * GetFlexWeight(child));
                ...
                foreach (UIElement child in Children) {
                    var arrangeRect = new Rect();
                    if (GetFlex(child)) arrangeRect = new Rect(currentLength, 0, child.DesiredSize.Width + flexSize * GetFlexWeight(child), finalSize.Height);
